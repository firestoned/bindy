...
## [2025-12-24 02:00] - CI/CD: Upgrade firestoned/github-actions to v1.3.2

**Author:** Erick Bourgeois

### Changed
- `.github/workflows/*.yaml`, `.github/workflows/*.yml`: Upgraded all `firestoned/github-actions` references from `v1.3.1` to `v1.3.2`
  - Updated 42 action references across 8 workflow files
  - Affected workflows: `docs.yaml`, `integration.yaml`, `license-scan.yaml`, `main.yaml`, `pr.yaml`, `release.yaml`, `sbom.yml`, `security-scan.yaml`
  - Actions updated:
...
### Why
Keep GitHub Actions workflows up-to-date with the latest stable release of firestoned/github-actions composite actions:
- **Bug Fixes**: Ensure workflows benefit from latest fixes
- **Security**: Use the most recent security-vetted action versions
- **Consistency**: Maintain uniform action versions across all workflows
- **Maintainability**: Single version simplifies troubleshooting and updates
