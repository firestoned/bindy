...
> **Status:** ⛔ Not started — designed in [ADR-0001](../../docs/adr/0001-rndc-secret-reload.md); no reload path exists in `src/`.
>
> *Migrated 2026-09-10 from the external roadmap set. Status verified against `fix-idempotency` @ `648ff7a`.*

---

> **Original status (as written):** 📋 Planned - See [ADR-0001](../../docs/adr/0001-rndc-secret-reload.md) for full design
...
See [ADR-0001: RNDC Secret Reload](../../docs/adr/0001-rndc-secret-reload.md) for:
...
- **ADR**: [ADR-0001](../../docs/adr/0001-rndc-secret-reload.md)
- **Issue**: TBD (to be created from [template](../ISSUE_TEMPLATE/feature-rndc-secret-reload.md))
