...
> **Status:** ⛔ Not started — no VEX generation step in `.github/workflows/`. Builds on the SBOM pipeline from [15](15-security-scanning.md).
>
> *Migrated 2026-09-10 from the external roadmap set. Status verified against `fix-idempotency` @ `648ff7a`.*

---

**Original status (as written):** Planned
**Date:** 2026-03-18
