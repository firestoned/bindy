...
> **Status:** ⛔ Not started — no `DNSSecurityPolicy`, `DNSCompliancePolicy` or report CRDs in `src/crd.rs`. The largest unstarted item here; needs an ADR before any of it is built.
>
