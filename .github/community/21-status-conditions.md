...
> **Status:** ✅ Done — phases 1–5 complete (`src/reconcilers/status.rs`, `src/status_reasons.rs`). Phases 6–7 remain explicitly-future work inside the doc.
>
...
**Original status (as written):** ✅ Phases 1-5 COMPLETE | Phases 6-7 FUTURE WORK
...
- `src/reconcilers/bind9cluster/mod.rs` - Use standard constants
- `src/reconcilers/bind9instance/mod.rs` - Use standard constants
...
**Files Modified:**
- `src/reconcilers/bind9instance/mod.rs`
...
**Files Modified:**
- `src/reconcilers/bind9cluster/mod.rs`
...
- [src/reconcilers/bind9instance/mod.rs](../../src/reconcilers/bind9instance/mod.rs) - Pod-level conditions
- [src/reconcilers/bind9cluster/mod.rs](../../src/reconcilers/bind9cluster/mod.rs) - Instance-level conditions
- `src/reconcilers/bind9globalcluster.rs` — cluster-level conditions *(renamed since; see `src/reconcilers/clusterbind9provider.rs`)*

**Tests:**
- `src/reconcilers/bind9instance_tests.rs` *(now `src/reconcilers/bind9instance/*_tests.rs`)*
- `src/reconcilers/bind9cluster_tests.rs` *(now `src/reconcilers/bind9cluster/*_tests.rs`)*

**Documentation:**
- [CHANGELOG.md](../../.claude/CHANGELOG.md) - Detailed change log
