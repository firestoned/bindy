...
**RBAC Permissions:**
```yaml
# Resources: dnszone, bind9instance, bind9cluster (dns.firestoned.io/v1alpha1)
...
- **Evidence:** [src/bind9_resources.rs:427-440](../../src/bind9_resources.rs#L427-L440) - SecurityContext configuration
...
- **Evidence:** [src/reconcilers/dnszone.rs](../../src/reconcilers/dnszone.rs), [src/reconcilers/bind9instance.rs](../../src/reconcilers/bind9instance.rs)
...
- **Evidence:** [src/bind9_resources.rs](../../src/bind9_resources.rs) - Secret references, no hardcoded values
...
**Implementation:**
- **Defined Process:** Development workflow documented in [CLAUDE.md](../../CLAUDE.md)
- **Automated Testing:** Unit, integration, and end-to-end tests
- **Code Review:** Mandatory PR review before merge
- **Evidence:** [.github/workflows/](../../.github/workflows/), [CLAUDE.md](../../CLAUDE.md)
...
**Implementation:**
- **Unit Tests:** Required for all public functions ([CLAUDE.md](../../CLAUDE.md))
...
- **Evidence:** [CLAUDE.md](../../CLAUDE.md) - Rust Style Guidelines
...
- **Evidence:** [src/bind9_resources.rs](../../src/bind9_resources.rs) - Secret references
...
- **Evidence:** [src/main.rs](../../src/main.rs) - health endpoints
...
- **Evidence:** [src/crd.rs](../../src/crd.rs) - JSON Schema definitions
