...
| Control | Implementation | Evidence Location |
|---------|----------------|-------------------|
| **Least Privilege RBAC** | Operator has minimal RBAC (create/delete secrets for RNDC lifecycle, delete managed resources for cleanup) | [`deploy/rbac/clusterrole.yaml`](../../../deploy/rbac/clusterrole.yaml) |
...
1. **RBAC Policy**: [`deploy/rbac/clusterrole.yaml`](../../../deploy/rbac/clusterrole.yaml) - Shows minimal required permissions with detailed rationale
