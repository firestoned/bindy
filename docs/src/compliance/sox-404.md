...
| Control | Implementation | Evidence Location |
|---------|----------------|-------------------|
| **Least Privilege RBAC** | Controller has minimal RBAC (create/delete secrets for RNDC lifecycle, delete managed resources for cleanup) | [`deploy/rbac/clusterrole.yaml`](../../../deploy/rbac/clusterrole.yaml) |
