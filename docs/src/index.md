...
- [Quick Start](./installation/quickstart.md) - Get started with Bindy quickly
- [Step-by-Step Guide](./installation/step-by-step.md) - Complete walkthrough from installation to DNS testing
- [Protocol Reference](./concepts/architecture-protocols.md) - Learn about RNDC and HTTP API protocols
